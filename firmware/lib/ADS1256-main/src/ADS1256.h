...
//Single-ended inputs
#define SING_0 0b00001111 //A0 + GND (common) as single-ended input //15
#define SING_1 0b00011111 //A1 + GND (common) as single-ended input //31
#define SING_2 0b00101111 //A2 + GND (common) as single-ended input //47
#define SING_3 0b00111111 //A3 + GND (common) as single-ended input //63
#define SING_4 0b01001111 //A4 + GND (common) as single-ended input //79
#define SING_5 0b01011111 //A5 + GND (common) as single-ended input //95
